...
if ( !CKEDITOR.event ) {
	...
	CKEDITOR.event.implementOn = function( targetObject ) {
		console.log("CKEDITOR.event.implementOn");
	...
	CKEDITOR.event.prototype = ( function() {
		console.log("CKEDITOR.event.prototype");
		// Returns the private events object for a given object.
		var getPrivate = function( obj ) {
				// console.log("CKEDITOR.event.prototype.getPrivate");
				var _ = ( obj.getPrivate && obj.getPrivate() ) || obj._ || ( obj._ = {} );
				return _.events || ( _.events = {} );
			};

		var eventEntry = function( eventName ) {
				// console.log("CKEDITOR.event.prototype.eventEntry");
				this.name = eventName;
				this.listeners = [];
			};
		...
		function getEntry( name ) {
			// console.log("CKEDITOR.event.prototype.getEntry");
		...
		return {
			...
			define: function( name, meta ) {
				console.log("CKEDITOR.event.return.define");
			 ...
			 */
			once: function() {
				console.log("CKEDITOR.event.return.once");
				var fn = arguments[ 1 ];
			 ...
			 */
			capture: function() {
				console.log("CKEDITOR.event.return.capture");
			 ...
			 */
			fire: ( function() {
				console.log("CKEDITOR.event.return.fire");
				// Create the function that marks the event as stopped.
				var stopped = 0;
				var stopEvent = function() {
						console.log("CKEDITOR.event.return.fire.stopEvent");
						stopped = 1;
					};
				...
				var cancelEvent = function() {
						console.log("CKEDITOR.event.return.fire.cancelEvent");
						canceled = 1;
					};
			...
			removeAllListeners: function() {
				console.log("CKEDITOR.event.return.removeAllListeners");
				var events = getPrivate( this );
				for ( var i in events )
					delete events[ i ];
			},
